...
export function RtcVideo({ stream, mirrored = false, objectFit = "cover", style }: { stream: any; mirrored?: boolean; objectFit?: "cover" | "contain"; style?: object }) {
  try {
    ...
    return <RTCView streamURL={streamURL} objectFit={objectFit} mirror={mirrored} style={[styles.video, style]} />;
  } catch {
    return <View style={[styles.empty, style]} />;
  }
}
