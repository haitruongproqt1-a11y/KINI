...
export default function DiscoverScreen() {
  ...
  useEffect(() => { if (active === "explore" && profile?.lat !== null && profile?.lng !== null) void find(); }, [active]);
