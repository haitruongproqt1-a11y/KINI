...
export default function HomeScreen() {
  ...
  const conversationsQuery = trpc.chat.list.useQuery({ filter }, { enabled: isAuthenticated, refetchInterval: 10_000, refetchIntervalInBackground: false, retry: 3 });
